...
public class GioHangSQLite extends SQLiteOpenHelper {

    public static final String DATABASE = "caycanh1.db";
    private static final String TABLE_NAME = "productGioHang";
    ...
    public GioHangSQLite( Context context) {
